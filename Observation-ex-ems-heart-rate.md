# Example EMS Vital Sign — Heart Rate - FHIR EMS Core Implementation Guide (Unofficial Research Project) v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Example EMS Vital Sign — Heart Rate**

## Example Observation: Example EMS Vital Sign — Heart Rate
