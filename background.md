# Background - FHIR EMS Core Implementation Guide (Unofficial Research Project) v0.2.0
...
1. **EMS → ED handoff**: FHIR-based transfer of pre-hospital data to receiving facilities
1. **Population health**: Aggregate EMS data in FHIR-compliant analytics platforms
1. **Bidirectional exchange**: Future roadmap for FHIR → EMS data flows
