...
Alias: $ext-ems-medical-director     = https://fhirems.github.io/fhirEMSCoreIG/StructureDefinition/ext-ems-medical-director
Alias: $ext-ems-agency-configuration = https://fhirems.github.io/fhirEMSCoreIG/StructureDefinition/ext-ems-agency-configuration
Alias: $ext-ems-usng                 = https://fhirems.github.io/fhirEMSCoreIG/StructureDefinition/ext-ems-usng
