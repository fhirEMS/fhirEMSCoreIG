...
2. **Extension** — an fhirEMSCore-defined extension when no native FHIR element exists
3. **Terminology binding** — a coded element with a NEMSIS value set bound to a FHIR CodeableConcept
4. **Not mapped** — elements that are derivable from other data or out of scope for this IG version

---

## eRecord Section

| NEMSIS Element | Description | FHIR Mapping |
|---|---|---|
