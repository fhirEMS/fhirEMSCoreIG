...
| NEMSIS Usage | NEMSIS Meaning | fhirEMSCore MS | FHIR Cardinality |
|---|---|---|---|
...
| Element | Cardinality | NEMSIS Source |
|---|---|---|
...
2. **If no `dataAbsentReason`** — use `ext-ems-not-value` extension; element cardinality may be 0..1 even though nominally required
...
2. Add `ext-ems-pertinent-negative` extension with the specific PN code
