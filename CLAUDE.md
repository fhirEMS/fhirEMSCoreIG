# CLAUDE.md — fhirEMSCore Implementation Guide

This file provides Claude with project context, conventions, and working instructions for the **fhirEMSCore** FHIR R4 Implementation Guide project.
