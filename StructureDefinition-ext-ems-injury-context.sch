...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'vehicleImpactArea']) &lt;= 1">extension with URL = 'vehicleImpactArea': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'patientVehicleLocation']) &lt;= 1">extension with URL = 'patientVehicleLocation': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'heightOfFall']) &lt;= 1">extension with URL = 'heightOfFall': maximum cardinality of 'extension' is 1</sch:assert>
