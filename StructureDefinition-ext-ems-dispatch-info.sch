...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'dispatchPriority']) &lt;= 1">extension with URL = 'dispatchPriority': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'cadRecordId']) &lt;= 1">extension with URL = 'cadRecordId': maximum cardinality of 'extension' is 1</sch:assert>
