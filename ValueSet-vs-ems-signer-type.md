# EMS SignerType VS - FHIR EMS Core Implementation Guide (Unofficial Research Project) v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **EMS SignerType VS**

## ValueSet: EMS SignerType VS 

| | |
| :--- | :--- |
| *Official URL*:https://fhirems.github.io/fhirEMSCoreIG/ValueSet/vs-ems-signer-type | *Version*:0.2.0 |
| Active as of 2026-07-19 | *Computable Name*:EMSSignerTypeVS |
| *Other Identifiers:*OID:2.25.219926138944530828037824748808947630693.2.142 | |

 
The type of person signing (eOther.12). 
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.25.219926138944530828037824748808947630693.2.142"
  }],
  "version" : "0.2.0",
  "name" : "EMSSignerTypeVS",
