# EMS Resuscitation Attempted VS - FHIR EMS Core Implementation Guide (Unofficial Research Project) v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **EMS Resuscitation Attempted VS**

## ValueSet: EMS Resuscitation Attempted VS 

| | |
| :--- | :--- |
| *Official URL*:https://fhirems.github.io/fhirEMSCoreIG/ValueSet/vs-ems-resuscitation-attempted | *Version*:0.2.0 |
| Active as of 2026-07-19 | *Computable Name*:EMSResuscitationAttemptedVS |
| *Other Identifiers:*OID:2.25.219926138944530828037824748808947630693.2.109 | |

 
Type of resuscitation attempted by the EMS unit (eArrest.03). 
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.25.219926138944530828037824748808947630693.2.109"
  }],
  "version" : "0.2.0",
  "name" : "EMSResuscitationAttemptedVS",
