...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhirems.github.io/fhirEMSCoreIG/StructureDefinition/ext-ems-arrest-context']) &lt;= 1">extension with URL = 'https://fhirems.github.io/fhirEMSCoreIG/StructureDefinition/ext-ems-arrest-context': maximum cardinality of 'extension' is 1</sch:assert>
