# NEMSIS vs US Core Differential - FHIR EMS Core Implementation Guide (Unofficial Research Project) v0.2.0
...
1. `ext-ems-pertinent-negative`extension carrying the specific PN code
