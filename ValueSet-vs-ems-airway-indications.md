# EMS Airway Indications VS - FHIR EMS Core Implementation Guide (Unofficial Research Project) v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **EMS Airway Indications VS**

## ValueSet: EMS Airway Indications VS 

| | |
| :--- | :--- |
| *Official URL*:https://fhirems.github.io/fhirEMSCoreIG/ValueSet/vs-ems-airway-indications | *Version*:0.2.0 |
| Active as of 2026-07-19 | *Computable Name*:EMSAirwayIndicationsVS |
| *Other Identifiers:*OID:2.25.219926138944530828037824748808947630693.2.16 | |

 
Indications for airway management intervention (eAirway.01). 
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.25.219926138944530828037824748808947630693.2.16"
  }],
  "version" : "0.2.0",
  "name" : "EMSAirwayIndicationsVS",
