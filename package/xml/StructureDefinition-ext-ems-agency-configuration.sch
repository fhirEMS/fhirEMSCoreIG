...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:extension[@url = 'billingStatus']) &lt;= 1">extension with URL = 'billingStatus': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'emdProvided']) &lt;= 1">extension with URL = 'emdProvided': maximum cardinality of 'extension' is 1</sch:assert>
